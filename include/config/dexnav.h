...
#define DN_FLAG_DEXNAV_GET            2 // DexNav shows in start menu
#define DN_FLAG_DETECTOR_MODE         3 // Allow player to find hidden mons
#define DN_VAR_SPECIES                4 // Registered DexNav species
