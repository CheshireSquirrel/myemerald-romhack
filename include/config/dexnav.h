...
// Flag/var defines
#define DN_FLAG_SEARCHING             0x60D // Searching for mon
#define DN_FLAG_DEXNAV_GET            0x60E // DexNav shows in start menu
#define DN_FLAG_DETECTOR_MODE         0x60F // Allow player to find hidden mons
#define DN_VAR_SPECIES                280 // Registered DexNav species
